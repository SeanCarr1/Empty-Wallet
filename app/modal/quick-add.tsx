...
import { X, Calendar, Clock, Edit3, ArrowDownLeft, ArrowUpRight, ArrowLeftRight, ChevronDown, Check, User, CreditCard, Banknote, Landmark, Globe } from 'lucide-react-native';
  ...
  return (
    <SafeAreaView className="flex-1 bg-background" edges={['top', 'bottom']}>
      ...
      <ScrollView className="flex-1 px-5 pt-2" showsVerticalScrollIndicator={false}>
        ...
        <View className="mb-3">
          <Text className="text-content-tertiary text-[11px] font-semibold uppercase tracking-wider mb-1">
        ...
        {/* 4. Category Dropdown / Selector (If Expense or Income) */}
        {type !== 'transfer' && (
          <View className="mb-3">
            <Text className="text-content-tertiary text-[11px] font-semibold uppercase tracking-wider mb-1">
              Category
            ...
            <View className="bg-background-elevated border border-background-border rounded-2xl p-2 mb-2">
              {PAYMENT_OPTIONS.map((opt) => (
                ...
                >
                  ...
                  {paymentType === opt.type && <Check size={16} color="#10B981" />}
                </TouchableOpacity>
              ))}
            </View>
          )}
              ...
              <View className="flex-row flex-wrap">
                {activeCategories.map((c) => {
                  ...
                  return (
                    ...
                    >
                      <Icon name={c.icon} size={18} color={isSelected ? '#10B981' : c.color} />
                      <Text
      ...
      <Modal visible={dateTimeModalOpen} animationType="slide" transparent>
        <View className="flex-1 bg-black/70 justify-end">
          <View className="bg-background-card rounded-t-3xl p-6 border-t border-background-border">
            ...
            {/* Quick Presets */}
            <Text className="text-content-secondary text-xs font-semibold uppercase mb-2">Quick Date</Text>
            ...
            {/* Date Input */}
            <Text className="text-content-secondary text-xs font-semibold uppercase mb-1">Date (YYYY-MM-DD)</Text>
            <TextInput
              value={dateStr}
            ...
            {/* Time Input */}
            <Text className="text-content-secondary text-xs font-semibold uppercase mb-1">Time (HH:mm)</Text>
            <TextInput
              value={timeStr}
            ...
            >
              <Text className="text-background font-bold text-xs">Done</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
